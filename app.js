    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.getElementById('formNovoMunicipio').addEventListener('submit', function(e) {
        ...
        mensagemAdicional.innerHTML = `
          ...
          <p>Para que o município apareça na página principal, será necessário adicionar um card para ele no arquivo index.html.</p>
        `;
        ...
        cardHtmlDiv.innerHTML = `
          ...
          <div class="card-body">
            <p>Copie este código e adicione-o na seção de municípios monitorados no arquivo index.html:</p>
        ...
        modalHtmlDiv.innerHTML = `
          ...
          <div class="card-body">
            <p>Copie este código e adicione-o dentro da div com id "modal-content-container" no arquivo index.html:</p>
        ...
        scriptDiv.innerHTML = `
          ...
          <div class="card-body">
            <p>Copie este código e adicione-o ao objeto dadosMunicipios no arquivo index.html:</p>
